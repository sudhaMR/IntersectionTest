...
#include "IntersectionTestsPawn.generated.h"
...
UCLASS(config=Game)
class AIntersectionTestsPawn : public AWheeledVehicle
{
	GENERATED_BODY()
...
public:
	...
	FVector GetPawnOrigin();

	UFUNCTION(BlueprintCallable)
	FVector GetPawnNormal();
